...
void splitToBands(py::array_t<T> inarray, py::array_t<T> outarray, int nchans,
    ...
    sigpyproc::splitToBands(indata, outdata, nchans, nsamps, nsub,
                            chanpersub, chanstart);
}
...
void dedisperse(py::array_t<T> inarray, py::array_t<float> outarray,
    ...
    sigpyproc::dedisperse(indata, outdata, delays_arr, maxdelay, nchans,
                          nsamps, index);
}
...
void foldFil(py::array_t<T> inarray, py::array_t<float> foldarray,
    ...
    sigpyproc::foldFil(indata, fold_arr, count_arr, delay_arr, maxDelay,
                       tsamp, period, accel, totnsamps, nsamps, nchans,
                       nbins, nints, nsubs, index);
}
...
void removeBandpass(py::array_t<T> inarray, py::array_t<T> outarray,
    ...
    sigpyproc::removeBandpass(indata, outdata, means_arr, stdevs_arr,
                              nchans, nsamps);
}
...
void removeZeroDM(py::array_t<T> inarray, py::array_t<T> outarray,
    ...
    sigpyproc::removeZeroDM(indata, outdata, bpass_arr, chanwts_arr,
                            nchans, nsamps);
}
...
void sumHarms(py::array_t<float> specarray, py::array_t<float> sumarray,
    ...
    sigpyproc::sumHarms(spec_arr, sum_arr, harm_arr, fact_arr,
...
void foldTim(py::array_t<float> inarray, py::array_t<double> foldarray,
    ...
    sigpyproc::foldTim(indata, fold_arr, count_arr,
